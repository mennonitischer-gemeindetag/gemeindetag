...
function setup() {
	...
	add_action( 'phpmailer_init', $n( 'configure_custom_php_mailer' ) );
...
function embed_ct_css() {
	...
	wp_register_style( 'ct', false, [], '1.0.0' );
	wp_enqueue_style( 'ct' );
...
/**
 * Add a custom email sender
 */
function configure_custom_php_mailer( $phpmailer ) {
	$phpmailer->isSMTP();
